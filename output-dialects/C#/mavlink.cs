...
{
    public const string MAVLINK_BUILD_DATE = "Thu Jul 20 2023";
    public const string MAVLINK_WIRE_PROTOCOL_VERSION = "1.0";
    public const int MAVLINK_MAX_PAYLOAD_LEN = 17;
    ...
    public static message_info[] MAVLINK_MESSAGE_INFOS = new message_info[] {
        ...
        new message_info(170, "CONTROL_SYSTEM", 67, 8, 8, typeof( mavlink_control_system_t )), // none 24 bit
        new message_info(171, "INSTRUMENTATION", 250, 16, 16, typeof( mavlink_instrumentation_t )), // none 24 bit
        new message_info(172, "TEMPERATURES", 192, 12, 12, typeof( mavlink_temperatures_t )), // none 24 bit
        new message_info(173, "GPS_INFO", 182, 17, 17, typeof( mavlink_gps_info_t )), // none 24 bit
        new message_info(174, "AUX_SYSTEM", 28, 12, 12, typeof( mavlink_aux_system_t )), // none 24 bit
